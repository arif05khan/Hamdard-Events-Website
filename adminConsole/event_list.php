<?php 
 ...
 $conn = new mysqli("localhost","root","","HamdardEvents");
...
<body>
        ...
        <nav>
            <div class="logo">
                <a href="adminIndex.php">
                    <label class="brand">Hamdard Events</label>
                </a>
            </div>
            <ul class="menu-nav">
                <li>
            ...
            <div class="container shadow p-5 my-5" id="addEventMethod" style="display: none">
                ...
                <form action="addEvent.php" method="POST">
                    ...
                    <br><select id="cars" name="event_name" class="form-control">
                        ...
                        <option value="Hamdard Idol">Hamdard Idol</option>
    ...
    <footer>
        <div class="container-fixed p-3">
            <p class="text-center text-white p-2">|----------Copyright &copy; 2024----------|</p>
            <div class="row text-center text-white">
                <div class="col-md-3">
                    <h1 style="font-weight: bold;">Jamia Hamdard University</h1>
                </div>
                <div class="col-md-6">
                    <p>Address:<br>Hamdard Nagar, New Delhi, Delhi, 110062</p>
                    <h4>Designed & Developed By ARIF RASUL KHAN</h4>
                </div>
                <div class="col-md-3">
                    <h1>Follow Us On</h1>
